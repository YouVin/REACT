  ...
  const handleAddressChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    */
    ...
    console.log(
      ...
      user.extra.addressBook === newUser.extra.addressBook
    ); // false
    console.log(
      "회사",
      user.extra.addressBook[0] === newUser.extra.addressBook[0]
    ); // false
    console.log(
      "회사 주소",
    ...
    console.log(
      "집",
      user.extra.addressBook[1] === newUser.extra.addressBook[1]
    ); // true
    console.log(
      "집 주소",
      user.extra.addressBook[1].value === newUser.extra.addressBook[1].value
    ); // true
